...
def generate_curves_between_points(x, y, num_curves=100, num_points=100, rand_scale=3.0, max_tries=1000, lims=[0.0,1.0], return_alpha=False):
    """
    Generate multiple valid curves between two points using cubic Hermite interpolation.
